    ...
    return <section>
        <nav className={'nav-menu'}>
            ...
            <div className='menu'>
                ...
                <a href="#experience" onClick={() => props.setSidebar(false)}><div className="subitem"><span className='icon'><i class="fa-solid fa-briefcase"></i></span> <span className="text">Experience</span></div></a>
                <a href="#works" onClick={() => props.setSidebar(false)}><div className="subitem"><span className='icon'><i class="fa-regular fa-file-code"></i></span> <span className="text">Works</span></div></a>
